...
public class CallActivity extends AppCompatActivity implements View.OnClickListener, SignallingClient.SignalingInterface {
    PeerConnectionFactory peerConnectionFactory;

    MediaConstraints audioConstraints;
    MediaConstraints videoConstraints;
    MediaConstraints sdpConstraints;
    MediaConstraints remoteSdpConstraints;
...
//        videoCapturerAndroid = getVideoCapturer(new CustomCameraEventsHandler());
...
//        httpRequestResult = serverService.syncServer();
//        Log.e("resultCode", httpRequestResult.getResultCode()+"");
//
...
//        }
        ...
        if(SignallingClient.getInstance().isInitiator){
            Log.e("start()에서 onTryToStarts", SignallingClient.getInstance().isChannelReady+"");
            onTryToStart();
        }
    ...
    private void createPeerConnection() {
        ...
        localPeer = peerConnectionFactory.createPeerConnection(rtcConfig, sdpConstraints,new CustomPeerConnectionObserver("localPeerCreation") {
            ...
            public void onAddStream(MediaStream mediaStream) {
                Log.e("onAddStream", mediaStream.toString());
                showToast("Received Remote stream");
                super.onAddStream(mediaStream);
                Log.d("test@@@", ":::createPeerConnectionOnAddStream");
...
//        remotePeer = peerConnectionFactory.createPeerConnection(iceServers, sdpCOnstraints, new CustomPeerConnectionObserver("remotePeerCreation") {
        remotePeer = peerConnectionFactory.createPeerConnection(iceServers, sdpConstraints, new CustomPeerConnectionObserver("remotePeerCreation") {
            ...
            public void onAddStream(MediaStream mediaStream) {
                super.onAddStream(mediaStream);
                Log.e("onAddStream3", mediaStream.toString());
                gotRemoteStream(mediaStream);
            }
